...
public class OfficeResource extends CrudResource<Office, OfficeService, Integer> {
    ...
    @Override
    public Response create(@Valid Office entity) {
    ...
    @Override
    public Response update(@PathParam("id") Integer id, @Valid Office entity) {
